...
class coins:
	...
	def calculate(n):
		...
		# initial we take two varialbles head and tails and assign default value 0
		head = 0
		tails = 0
		i = 0
		...
		print("Percentage of head is : ",round((head*100)/n , 2))
		print("Percentage of tails is : ",round((tails*100)/n , 2))