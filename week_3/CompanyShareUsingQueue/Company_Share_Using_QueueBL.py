...
# Date : 30/08/2019
# implement QUEUE using linked list according to requirement for modification in company share and update JSON file
# ---------------------------------------------------------------------------------------------
...
class stock_function:
    ...
    def dequeue(self):
        ...
        if self.head is None:  # or self.Top == 0:
            print('Under flow')
            return
    ...
    def sell_stock(self, stock_name, record):
        if obj.search_stock(stock_name):
            ...
            print('\t\n::This stock symbol not present in record!! \n')
    ...
    def createQueue(self, file_record):
        print("create Queue")
